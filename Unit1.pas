...
const
  ...
  P1 = 90;   { Количество поколений }
  S1 = 190;   { Размер популяции }
...
begin
  ...
  //writeln('Минимум вещественной функции = ', BestMin: 12: 6);
  //writeln('Максимум вещественной функции = ', BestMax: 12: 6);
...
begin
  ...
  for I := 1 to N do
  begin
    Xn[i]:=-Random(100*i); // начальные значения
    Xk[i]:= abs(Xn[i]); // конечные значения
  end;
